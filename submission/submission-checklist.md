...
Deadline: September 3, 2026 at 1:00 p.m. PDT / 4:00 p.m. EDT.

- [x] Original WebMCP-powered product with meaningful human-agent collaboration
- [x] Public HTTPS app accessible to judges
- [x] Native WebMCP verified in ChatGPT's in-app browser
- [x] Contextual discovery, shared durable state, structured errors, and human authority boundary
- [x] Public source includes all app code and assets
- [x] MIT license visible at repository root
...
- [ ] Devpost success page and public project page verified
